...
# =========================
def reset_game():
    global ball_x, ball_y, shooting, shot_direction, shot_speed
    global goalkeeper_x, goalkeeper_y, goalkeeper_speed, goalkeeper_direction
    global power_gauge, power_direction, result_text, clicked_arrow
...
while True:
    ...
    if scene == "game":
        ...
        # # [테스트 도우미] 히트박스 시각화 선
        # pygame.draw.rect(DISPLAYSURF, (255, 0, 0), goalkeeper_rect, 2)
        # pygame.draw.rect(DISPLAYSURF, (0, 255, 0), goal_rect, 2)
    ...
    # =====================
        ...
        clear_text = font.render("STAGE 8 클리어!", True, (255, 255, 255))
